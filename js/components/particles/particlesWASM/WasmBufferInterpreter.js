...
export class WasmBufferInterpreter {
    ...
    getParticleData(index) {
        ...
        return {
            ...
            speed_x: this.wasmParticlesBuffer[baseIndex + SPEED_X - 1],
            speed_y: this.wasmParticlesBuffer[baseIndex + SPEED_Y - 1],
            size: this.wasmParticlesBuffer[baseIndex + SIZE - 1],
            color_red: this.wasmParticlesBuffer[baseIndex + COLOR_RED - 1],
            color_green: this.wasmParticlesBuffer[baseIndex + COLOR_GREEN - 1],
            color_blue: this.wasmParticlesBuffer[baseIndex + COLOR_BLUE - 1],
