...
pub struct Opts {
    #[serde(rename = "SHOOTING_STARS")]
    pub shooting_stars: bool,

    // Particles
    #[serde(rename = "NUMBER_OF_PARTICLES")]
    pub number_of_particles: usize,
    #[serde(rename = "MAX_NUMBER_OF_PARTICLES")]
    pub max_number_of_particles: usize,
    ...
    pub impulse_size: f32,
    #[serde(rename = "MAX_IMPULSES")]
    pub max_impulses: usize,
    #[serde(rename = "IMPULSE_UPDATE_STEPS")]
    pub impulse_update_steps: u8,
